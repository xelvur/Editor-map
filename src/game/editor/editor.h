...
#undef REGISTER_QUICK_ACTION
	...
	bool m_AndroidPickerForced = false; // Toggle tile picker via touch toolbar
	bool m_AndroidLockMode = false;     // Lock: block all drawing, only zoom/pan allowed
#endif
	...
	void RenderAndroidTouchToolbar(); // Android-only: big touch buttons at bottom
